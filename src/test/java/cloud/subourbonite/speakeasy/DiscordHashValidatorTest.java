...
class DiscordHashValidatorTest {
    ...
    @Test
    void testRejectsInvalidSignature() throws IOException, URISyntaxException {
        ...
        APIGatewayV2HTTPResponse response = validator.handleRequest(
                APIGatewayV2HTTPEvent.builder()
                        ...
                        .withHeaders(Map.of("x-signature-timestamp", "1725595487", "x-signature-ed25519",
    ...
    @Test
    void testAllowsValidSignature() throws IOException, URISyntaxException {
        DiscordHashValidator validator = new DiscordHashValidator("", "",
                "7d36900458a5bdcc92dbcb5a17fd1099bed501d6454c2b694d5c033139ece1ad");
